...
You are welcome however to grab this code and have the demonstration site running on your end. By doing this you have the chance to see the ["Conference Lite" theme in action](http://demo.drupalizing.com/conference-lite/site) exactly the way it looks like on our demo.
