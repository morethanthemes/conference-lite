...
function conference_lite_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'conference_lite/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'conference_lite'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['page_container']['page_container_border'] = array(
    ...
    '#default_value' => theme_get_setting('page_container_border', 'conference_lite'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['header']['fixed_header'] = array(
    ...
    '#default_value' => theme_get_setting('fixed_header', 'conference_lite'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'conference_lite'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_icon','conference_lite'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (conference_lite/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'conference_lite'),
    '#options' => array(
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['color_scheme'] = array(
    ...
    '#default_value' => theme_get_setting('color_scheme', 'conference_lite'),
    '#options' => array(
    'blue' => t('Blue (Default)'),
    'khaki' => t('Khaki'),
    'gold' => t('Gold'),
